-- Follow-Up Question Pre-Generation System Schema
...
CREATE TABLE IF NOT EXISTS public.follow_up_generation (
    ...
    source_entry_id UUID REFERENCES public.journal_entries(id), -- The past journal entry used to generate this question
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW(),
    UNIQUE(user_id) -- One active question per user
);
...
-- 7. Create RLS policies for follow_up_generation table
