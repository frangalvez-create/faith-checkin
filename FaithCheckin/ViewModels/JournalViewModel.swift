        ...
        do {
            ...
            if !eligibility.isEligible {
                let message = analysisType == "monthly"
                    ? "Sorry, a minimum of \"nine days\" of entries is needed to run the monthly analysis."
                    : "Sorry, a minimum of \"two days\" of entries is needed to run the weekly analysis. Try again next week"
