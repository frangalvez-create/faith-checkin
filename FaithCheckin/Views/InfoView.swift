                    ...
                    VStack(spacing: 0) {
                        ...
                        VStack(spacing: 20) {
                            ...
                            VStack(alignment: .leading, spacing: 10) {
                                ...
                                Text("The materials on the Faith Check-in application are provided \"as is.\" Faith Check-in makes no warranties or guarantees that the information is correct, complete, or up to date. We link to OpenAI for AI-related content and cannot guarantee the accuracy, reliability, or suitability of the AI responses. All outputs displayed come directly from OpenAI's language model and are not edited or altered by Faith Check-in.\n\nThe content provided in the app, including AI-generated suggestions, check-in prompts, and insights, is for informational and spiritual reflection purposes only. It is not a substitute for professional medical, psychological, therapeutic, or spiritual counseling advice, diagnosis, or treatment. Always seek the guidance of a qualified health professional or spiritual advisor with any questions you may have regarding your spiritual, mental, physical health, or well-being.\n\nBy using Faith Check-in, you acknowledge and agree that:\n• You use the app at your own discretion and risk.\n• Faith Check-in and its affiliates are not responsible or liable for any actions you take or decisions you make based on the information provided.\n• We do not guarantee that the app will be error-free, uninterrupted, or free of harmful components.\n• Links to third-party services or resources are provided for convenience and do not imply endorsement.")
                                    .font(.system(size: 12))
                            ...
                            VStack(alignment: .leading, spacing: 10) {
                                ...
                                Text("By downloading, accessing, or using the Faith Check-in application (\"App\"), you agree to the following Terms of Use (\"Terms\"). Please read them carefully. If you do not agree, you may not use the App.\n\nPurpose of the App - Faith Check-in is a spiritual check-in and reflection tool that provides prompts, insights, and AI-generated content. The App is for personal use only and is not intended to provide medical, psychological, therapeutic, or spiritual counseling advice.\n\nEligibility - You must be at least 13 years old (or the minimum legal age in your country) to use the App. By using the App, you confirm that you meet these requirements.\n\nUser Responsibilities - You agree to use the App only for lawful and personal purposes. You are responsible for the content you create, upload, or store within the App. You may not misuse the App, attempt to disrupt its operation, or use it to harm others.\n\nAI-Generated Content - The App integrates with OpenAI to provide AI-generated insights. Faith Check-in does not control or guarantee the accuracy, reliability, or suitability of this content. All AI outputs are for informational purposes only and should not be relied upon as professional advice.\n\nPrivacy - Your privacy is important to us. Please review our Privacy Policy [link to policy] to understand how we collect, use, and protect your data.\n\nIntellectual Property - All content, design, and materials within the App (except user-generated entries) are the property of Faith Check-in or its licensors. You may not copy, distribute, or use them without permission.\n\nDisclaimers - The App is provided on an \"as is\" and \"as available\" basis. Faith Check-in makes no warranties or guarantees regarding the App's availability, reliability, or accuracy. The App does not replace professional medical, spiritual counseling, or legal advice.\n\nLimitation of Liability - To the maximum extent permitted by law, Faith Check-in and its affiliates will not be liable for any direct, indirect, incidental, or consequential damages resulting from your use of the App.\n\nTermination - We may suspend or terminate your access to the App at any time, without notice, if you violate these Terms or misuse the App.\n\nChanges of These Terms - We may update these Terms from time to time. Continued use of the App after changes are posted means you accept the revised Terms.\n\nGoverning Law - These Terms are governed by the laws of California, USA. Any disputes will be handled in the local courts.")
                                    .font(.system(size: 12))
                                    .foregroundColor(Color(hex: "545555"))
                                    .frame(maxWidth: .infinity, alignment: .leading)
                                    .padding(.leading, 15) // 15pt left padding
                            ...
                            VStack(alignment: .leading, spacing: 10) {
                                ...
                                Text("At Faith Check-in, your privacy matters to us. This Privacy Policy explains how we collect, use, and protect your information when you use the Faith Check-in application (\"App\").\n\nInformation We Collect - 1) Check-in Entries: Any content you choose to write and store in the App. 2) Account Information (if applicable): Such as your email, name, or preferences. 3) Usage Data: Non-identifiable information like device type, app activity, and performance logs to help us improve the App. We do not sell or share your personal check-in entries with advertisers.\n\nHow We Use Your Information - Provide check-in features and insights. Deliver AI-generated suggestions and prompts (via OpenAI). Improve and maintain the App. Communicate with you about updates, features, or important notices.\n\nAI-Generated Content - The App connects to OpenAI to provide check-in prompts and insights. When you submit text for AI processing, it is transmitted to OpenAI's servers. Faith Check-in does not control or guarantee how OpenAI processes or stores this data—please review OpenAI's Privacy Policy for more information.\n\nData Storage and Security - Your check-in entries are stored securely and are accessible only to you. We use reasonable security measures to protect your data, but no system is 100% secure. We cannot guarantee absolute protection.\n\nSharing of Information - We do not share, sell, or rent your personal information to third parties. Information may be shared only in the following cases: 1) With service providers who help us operate the App (e.g., cloud hosting). 2) If required by law or to protect the safety of users or the public.\n\nChildren's Privacy - Faith Check-in is not directed at children under 13 (or the minimum legal age in your country). We do not knowingly collect personal information from children.\n\nChanges to This Policy - We may update this Privacy Policy from time to time. We will notify you of material changes by posting the new version in the App. Continued use of the App means you accept the updated policy.")
                                    .font(.system(size: 12))
                                    .foregroundColor(Color(hex: "545555"))
                                    .frame(maxWidth: .infinity, alignment: .leading)
                                    .padding(.leading, 15) // 15pt left padding
                            ...
                            VStack(alignment: .leading, spacing: 10) {
                                ...
                                Text("If you no longer wish to keep your account with this app, you can delete your check-in entries, user profiles and associated data at any time by simply clicking below.")
                                    .font(.system(size: 12))
                                    .foregroundColor(Color(hex: "545555"))
                                    .frame(maxWidth: .infinity, alignment: .leading)
                                    .padding(.leading, 15) // 15pt left padding
