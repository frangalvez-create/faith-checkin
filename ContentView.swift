...
Task: Summarize the user's response using established theological and biblical historical knowledge.
...
Paragraph 1: empathetically acknowledge the user's focus/concern and provide a factual explanation relevant to the input.
            ...
            if analyzerViewModel.moodCounts.isEmpty {
                VStack(spacing: 12) {
                    ...
                    Text("No mood data available yet.")
                        ...
                        .foregroundColor(Color(hex: "3F5E82"))
                        .multilineTextAlignment(.center)
                    Text("Click Analyze below to see your top moods for the week.")
                        .font(.system(size: 13))
                        .foregroundColor(Color(hex: "3F5E82").opacity(0.7))
                        .multilineTextAlignment(.center)
                }
    ...
    private var infoPopupView: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("• After completing your entry, you can tap the \"Insight\" button to receive customized faith-based insights.")
                    .font(.system(size: 15))
                    .foregroundColor(Color(hex: "545555"))
    ...
    private var q3InfoPopupView: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("• The guided question changes daily. The topics include faith, prayer, gratitude, spiritual growth, biblical reflection and other similar topics.")
                    .font(.system(size: 15))
                    .foregroundColor(Color(hex: "545555"))
                
                Text("• These questions are designed to help you reflect on specific aspects of your life and spiritual well-being.")
                    .font(.system(size: 15))
                    .foregroundColor(Color(hex: "545555"))
                
                Text("• After completing your entry, you have an option to tap the \"Insight\" button to receive customized faith-based AI insights.")
                    .font(.system(size: 15))
                    .foregroundColor(Color(hex: "545555"))
    ...
    private var q4InfoPopupView: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("• Generates a Faith Score - how spiritually centered you are based on your log entries (0-100)")
                    .font(.system(size: 15))
                    .foregroundColor(.white)
                    .multilineTextAlignment(.leading)
                    .frame(maxWidth: .infinity, alignment: .leading)
