...
class AnalyzerViewModel: ObservableObject {
    ...
    func determineAnalysisMode(for date: Date) -> AnalyzerMode {
        ...
        let components = calendar.dateComponents([.year, .month], from: previousSunday)
        ...
        let previousSaturdayMonth = calendar.component(.month, from: previousSunday)
        let previousSaturdayYear = calendar.component(.year, from: previousSunday)
